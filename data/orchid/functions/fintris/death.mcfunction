...
execute as @s[scores={fintris.compareUUID.0=1..}] run tellraw @a [{"selector":"@a[tag=ecdeathtag]","italic":false}, {"text":" was spliced across all 6 infinites by "}, {"selector":"@s","italic":false}]
